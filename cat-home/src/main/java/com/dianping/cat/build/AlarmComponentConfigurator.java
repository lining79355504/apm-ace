...
import com.dianping.cat.report.alert.sender.spliter.*;
...
public class AlarmComponentConfigurator extends AbstractResourceConfigurator {
	...
	public List<Component> defineComponents() {
		...
		all.add(C(WxAppClient.class).req(WxAppConfigManager.class));
		...
		all.add(C(Sender.class, WeComSender.ID, WeComSender.class).req(SenderConfigManager.class, WxAppClient.class, OaUserInfoService.class));
